  ...
  return (
    <main className="min-h-screen bg-base-200 pt-16">
      <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-10">
        <div className="grid w-full max-w-6xl items-center gap-8 lg:grid-cols-[minmax(0,460px)_1fr]">
          <section className="w-full rounded-lg border border-base-300 bg-base-100 p-6 shadow-xl sm:p-8 lg:p-10">
          ...
          <AuthImagePattern
            title="Campus talks, instantly."
            subtitle="Join classmates, share updates, and keep every conversation flowing in one clean real-time chat space."
          />
        </div>
      </div>
    </main>
